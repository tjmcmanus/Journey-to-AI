...
1.  In the CPD web client, click the **Navigation Menu** ("hamburger" icon) > **Projects**.
...
1. You will first see AutoAI go into a **Preparin**g mode... then it will be **Pending**.
...
1. Click the **Edit** (pencil) **icon** to put the Notebook in edit mode.
 ...
 | | Fix the problem by leaving this screen and going to **My Instances** > **Environments** and then delete the Runtime environment for Python 3.6 that is currently running. Try opening the notebook again after returning to the project. ![image](./images/media/image39.png)|
...
1. **Model Evaluation** shows the various evaluation accuracy figures. Click through them but make sure to return to the original view - Multi-Class.
  ![image](./images/media/image54.png)
1. Precision Recall Curve Shows the tradeoff between precision and recall.
  ![image](./images/media/image55.png)
1. Threshold Chart helps choose a threshold for best performance based on the chosen measure of performance.
  ![](./images/media/image56.png)
1. Model Information gives info on type of model fitted.
  ![](./images/media/image57.png)
1. Feature Transformations displays new features created by AutoAI. This is a powerful capability of AutoAI because this is not something a Data Scientist may intuitively do themselves in a notebook. (Note: your results may vary from this screen shot.)
  ![](./images/media/image58.png)
1. Feature Importance displays the relative importance of the feature in predicting the target.
...
1. Hover your mouse over the right side of your Top Rank model, click Save as a Model.
  ![image](./images/media/image60.png)
1. In the screen *Save as model*:
  - Model name: keep it as is
  - Description: CPD Workshop AutoAI experiment
  - Click Save.
  ![image](./images/media/image61.png)
1. Exit the confirmation pop up by clicking x.
  ![image](./images/media/image62.png)

### **Saving the model as a notebook**
1. On the top right corner of the screen, click Save as a Notebook.
  ![](./images/media/image63.png)
1. In the screen *New notebook*:
  - Name: keep it as is
  - Description: CPD Workshop AutoAI -- Notebook creation
  - Click Create notebook.
  ![image](./images/media/image64.png)
1. You will be taken to the new notebook in edit mode in the project.  Take a moment to examine the new auto-generated notebook you just created. Exit the notebook by clicking CPD Workshop Analytics Project on the breadcrumb trail.
  ![image](./images/media/image65.png)

### **Reviewing the project**
1. You should be back in the project and under the Assets tab. (If you are not, navigate there now.)
1. Scroll down to find the Notebooks section. There you will find the AutoAI generated notebook you were just in.
  ![](./images/media/image34.png)
  ![image](./images/media/image66.png)
1. Scroll down farther to find the model you created from the AutoAI save feature. Select the ChurnRisk AutoAI experiment -- P4 RandomForestClassifierEstimator.
  ![image](./images/media/image67.png)
1. Review your new AutoAI generated model.
  ![](./images/media/image68.png)
1. Close any extra browser tabs you may have open, leaving only one.
